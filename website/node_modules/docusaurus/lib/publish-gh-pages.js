...
var publishConfig=require(process.cwd()+'/publishConfig.js');

var GIT_USER=process.env.GIT_USER;
var CIRCLE_BRANCH=process.env.CIRCLE_BRANCH;
var CIRCLE_PROJECT_USERNAME=process.env.CIRCLE_PROJECT_USERNAME;
var CIRCLE_PROJECT_REPONAME=process.env.CIRCLE_PROJECT_REPONAME;
var CI_PULL_REQUEST=process.env.CI_PULL_REQUEST;
var remoteBranch='https://'+GIT_USER+'@github.com/'+CIRCLE_PROJECT_USERNAME+'/'+CIRCLE_PROJECT_REPONAME+'.git';
...
if(CL_PULL_REQUEST||CIRCLE_BRANCH!=='master'){
