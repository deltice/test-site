...
var docComp=React.createElement(DocsPost,{config:siteConfig,metadata:_metadata,language:language,content:rawContent,__source:{fileName:_jsxFileName,lineNumber:108}});
...
var str=renderToStaticMarkup(React.createElement(ReactComp,{language:'en',__source:{fileName:_jsxFileName,lineNumber:126}}));
writeFileAndCreateFolder(targetFile,str);
}else
if(file.match(/\.css$/)){
console.log(file);
