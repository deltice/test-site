...
var docComp=React.createElement(DocsPost,{config:siteConfig,metadata:metadata,language:language,content:rawContent,__source:{fileName:_jsxFileName,lineNumber:153}});
...
var str=renderToStaticMarkup(React.createElement(ReactComp,{language:'en',__source:{fileName:_jsxFileName,lineNumber:181}}));
...
res.send(renderToStaticMarkup(React.createElement(_ReactComp,{language:'en',__source:{fileName:_jsxFileName,lineNumber:189}})));
}else{
console.log(req.path);
