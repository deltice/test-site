...
var docComp=React.createElement(DocsPost,{config:siteConfig,metadata:metadata,language:language,content:rawContent,__source:{fileName:_jsxFileName,lineNumber:154}});
...
var str=renderToStaticMarkup(React.createElement(ReactComp,{language:'en',__source:{fileName:_jsxFileName,lineNumber:182}}));
...
res.send(renderToStaticMarkup(React.createElement(_ReactComp,{language:'en',__source:{fileName:_jsxFileName,lineNumber:190}})));
}else{
console.log(req.path);
