...
const siteConfig = {
  ...
  headerLinksInternal: [
    {
      section: 'docs',
      href: '/test-app/docs/LANGUAGE/getting-started.html',
      text: 'Docs',
    },
    {section: 'api', href: '/test-app/docs/LANGUAGE/api.html', text: 'API'},
    {section: 'help', href: '/test-app/LANGUAGE/help.html', text: 'Help'},
    {section: 'blog', href: '/test-app/blog/', text: 'Blog'},
  ],
  headerLinksExternal: [
    {
      section: 'github',
  ...
  docsSidebarDefaults: {
    layout: 'docs',
    root: '/test-app/docs/en/getting-started.html',
    title: 'Docs',
  },
